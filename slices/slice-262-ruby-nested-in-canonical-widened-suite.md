...
Promote the nested portable descriptor for grammar `ruby` into the canonical
widened suite set.
...
1. the widened canonical manifest MAY expose the nested portable descriptor for
   grammar `ruby`
