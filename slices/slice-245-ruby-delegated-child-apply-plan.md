...
This proves that delegated child groups inside comment-owned surfaces can move
into the same shared apply-planning shape as top-level delegated child groups.
