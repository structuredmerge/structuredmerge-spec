# Slice 458: Structured Edit Provider Batch Execution Request Transport Envelope

## Goal

Wrap the shared provider batch execution request in a versioned transport
envelope.
