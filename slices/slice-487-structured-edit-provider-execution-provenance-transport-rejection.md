# Slice 487: Structured Edit Provider Execution Provenance Transport Rejection

## Goal

Standardize import rejection for invalid provider execution-provenance transport
envelopes.
...
- This slice standardizes rejection only, not provenance replay.
