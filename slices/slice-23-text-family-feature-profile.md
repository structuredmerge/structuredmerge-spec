...
- add a family profile for `plain-merge`
...
1. `plain-merge` reports family identity as `text`
2. `plain-merge` reports an empty dialect list
3. `plain-merge` reports an empty policy list until text policies are named
